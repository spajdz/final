...
class AppController extends Controller
{
	...
	public $components	= array(
		...
		'Breadcrumb' => array(
			'crumbs'		=> array(
				array('<i class="fa fa-play"></i>', null),
				array('Home', '/'),
			)
		)
	);
	...
	public function beforeRender()
	{
		...
		{
			$showBreadFirst = true;
			$this->set(compact('showBreadFirst'));
			...
			$aros_llantas_vehiculos		= $Producto->aros(1);
			$apernaduras_vehiculos		= array('Apernadura');
			$this->set(compact('anchos_neumaticos', 'perfiles_vehiculos', 'aros_vehiculos', 'apernaduras_vehiculos', 'aros_llantas_vehiculos'));

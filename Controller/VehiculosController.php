...
class VehiculosController extends AppController
{
	...
	public function aros_marca_modelo_version_ano($tipo = null, $nombre_marca = null, $nombre_modelo = null, $nombre_version = null, $ano = null){
		$this->layout='ajax';

		$aros = $this->Vehiculo->arosByMarcaModeloVersionAno($tipo, $nombre_marca, $nombre_modelo, $nombre_version, $ano);
	...
	public function apernaduras_marca_modelo_version_ano_aro($nombre_marca = null, $nombre_modelo = null, $nombre_version = null, $ano = null,$aro = null){
		$this->layout='ajax';

		$apernaduras = $this->Vehiculo->apernadurasByMarcaModeloVersionAnoAro($nombre_marca, $nombre_modelo, $nombre_version, $ano, $aro);

		// prx( $this->Vehiculo->getDataSource()->getLog(false, false));

		$this->set(compact('apernaduras'));
	}

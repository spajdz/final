    ...
    <div class="container-fluid interior">
      ...
      <div class="col-md-12 tabla-carro">
        <div class="felicidades clearfix">
          ...
          <p>Se ha realizado su solicitud de compra de manera satisfactoria.</p>
          <p>En instantes se comunicaran con usted.</p>
        ...
        <div class="form-group" >
          <div class="col-lg-12">
            <p><span>Método de pago:</span> 
                ...
                foreach ($TipoPagos as $key => $pago) {
                    if ($tipopagoselect == $key) {
                        echo $pago;
                        $tipoPago = $pago; 
                    }
                    # code...
            ...
            <p><span>Resultado transacción:</span> <span class="label label-success">Pendiente de aprobación</span></p>
            <p><span>Orden de compra N°:</span> <?= $compra['Compra']['id']; ?></p>
            <p><span>Tipo de Pago:</span> <?= $tipoPago; ?></p>
          </div> 
        </div>
    </form>                            
</div>                                

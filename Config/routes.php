...
Router::connect('/formas-de-pago', array('controller' => 'pages', 'action' => 'display', 'pago'));
Router::connect('/politicas-de-tienda-online', array('controller' => 'pages', 'action' => 'display', 'politicastiendaonline'));

Router::connect('/servicios', array('controller' => 'Servicios', 'action' => 'index'));
Router::connect('/servicios/*', array('controller' => 'Servicios', 'action' => 'view'));

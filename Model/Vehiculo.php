...
class Vehiculo extends AppModel
{
	...
	public function arosByMarcaModeloVersionAno($tipo = null, $nombre_marca = null, $nombre_modelo = null, $nombre_version = null, $ano = null){
		return $this->find('list', array(
			'cache'			=> 'aros_marca_modelo_version_ano',
			'fields'			=> array(
				'Vehiculo.aro',
				'Vehiculo.aro'
			),
	...
	public function apernadurasByMarcaModeloVersionAnoAro( $nombre_marca = null, $nombre_modelo = null, $nombre_version = null, $ano = null, $aro = null){
		return $this->find('list', array(
			'cache'			=> 'apernaduras_marca_modelo_version_ano_aro',
			'fields'			=> array(
				'Vehiculo.apernadura',
				'Vehiculo.apernadura'
			),
			...
			'group' => array('Vehiculo.apernadura'),
			'callbacks' 		=> false
		));
	}
}

...
jQuery(document).ready(function($)
{
   ...
   function MarcarcategoriasTodas(){
	...
	function Admin_Imagenes_AgregarOtraImagen () {
		...
		NuevaImagenHTML += "<tr>";
		NuevaImagenHTML += "	<td>";
		NuevaImagenHTML += "		<input id='ImagenProducto" + NuevaImagenID + "Imagen' class='' type='file' data-field='portada' data-model='ImagenProducto' name='data[ImagenProducto][" + NuevaImagenID + "][imagen]'>";
		NuevaImagenHTML += "	</td>";
		NuevaImagenHTML += "</tr>";
		$("table#lista-imagenes").append(NuevaImagenHTML);
	}
	function Admin_Imagenes_EliminarImagen (obj, ImagenID) {
		$(obj).parent().parent().remove();
		var ImgsEliminadas = $("input#imageneseliminadas").val();
		if (ImgsEliminadas != "") ImgsEliminadas += "," ;
		ImgsEliminadas += ImagenID;
